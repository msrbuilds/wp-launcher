# WPL Productivity Tracker

Track your coding time automatically from VS Code. Part of the [WP Launcher](https://wplauncher.msrbuilds.com) productivity monitoring system — a WakaTime-like time tracker that combines your coding activity with WordPress site activity in a single dashboard.
...
3. **Cloud account linked**
   ...
   - Enter your WP Launcher Cloud URL and API key (get your key from the cloud dashboard)
...
| Metric | How |
|--------|-----|
| **Language** | VS Code's built-in language detection (TypeScript, PHP, CSS, etc.) |
...
| **Editor** | `vscode` |
| **Machine** | VS Code's unique machine ID (for multi-device tracking) |
