# WPL Productivity Tracker for Windsurf

Track your coding time automatically from Windsurf. Part of the [WP Launcher](https://wplauncher.msrbuilds.com) productivity monitoring system — a WakaTime-like time tracker that combines your coding activity with WordPress site activity in a single dashboard.
...
1. **Install this extension** from [OpenVSX](https://open-vsx.org/extension/msrbuilds/wpl-productivity-windsurf)
...
| Metric | How |
|--------|-----|
| **Language** | Windsurf's built-in language detection (TypeScript, PHP, CSS, etc.) |
...
| **Editor** | `windsurf` |
| **Machine** | Windsurf's unique machine ID (for multi-device tracking) |
...
- **Windsurf** (current) — [OpenVSX](https://open-vsx.org/extension/msrbuilds/wpl-productivity-windsurf)
- **Antigravity** — [OpenVSX](https://open-vsx.org/extension/msrbuilds/wpl-productivity-antigravity)
