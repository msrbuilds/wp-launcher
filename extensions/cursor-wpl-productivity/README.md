# WPL Productivity Tracker for Cursor

Track your coding time automatically from Cursor. Part of the [WP Launcher](https://wplauncher.msrbuilds.com) productivity monitoring system — a WakaTime-like time tracker that combines your coding activity with WordPress site activity in a single dashboard.
...
1. **Install this extension** from [OpenVSX](https://open-vsx.org/extension/msrbuilds/wpl-productivity-cursor)
...
| Metric | How |
|--------|-----|
| **Language** | Cursor's built-in language detection (TypeScript, PHP, CSS, etc.) |
...
| **Editor** | `cursor` |
| **Machine** | Cursor's unique machine ID (for multi-device tracking) |
...
- **Cursor** (current) — [OpenVSX](https://open-vsx.org/extension/msrbuilds/wpl-productivity-cursor)
